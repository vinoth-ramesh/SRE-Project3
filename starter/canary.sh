#!/bin/bash
# used the script from: https://github.com/udacity/nd087-c3-self-healing-architectures-exercises/blob/master/lesson-2-deployment-strategies/exercises/solution/exercise-3/canary.sh
# script was created by; emmanuel-apau
